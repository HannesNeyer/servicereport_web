...
export default function LoginPage({ }: Props) {
    return (
        <div>
            <div className='relative w-[23.8rem] ml-96 mt-48'>
                <div className='flex'>
                    <img src="sonderhofLogo.png" className='mt-2 w-18 h-12'></img>
                    <h1 className='font-bold text-5xl font-sans text-[#029294] z-10'>ServiceReport</h1>
                </div>
            ...
            <div className=''>
                <img src="henkelSonderhofLogo.png" className='mt-2 w-96 h-38'></img>
            </div>
        </div>
    )
}